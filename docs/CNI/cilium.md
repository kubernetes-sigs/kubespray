...
As part of cluster.yml, this DaemonSet is restarted, and Kubespray's [default timeouts for this operation](https://raw.githubusercontent.com/kubernetes-sigs/kubespray/master/roles/network_plugin/cilium/defaults/main.yml)
