...
can be used.
You should use the [`kubeadm_patches` variable](https://raw.githubusercontent.com/kubernetes-sigs/kubespray/master/roles/kubernetes/kubeadm_common/defaults/main.yml) for that purpose.
