...
- Core
  - [kubernetes](https://github.com/kubernetes/kubernetes) 1.34.12
  - [etcd](https://github.com/etcd-io/etcd) 3.5.34
  - [docker](https://www.docker.com/) 28.3
  - [containerd](https://containerd.io/) 2.2.9
  - [cri-o](http://cri-o.io/) 1.34.14 (experimental: see [CRI-O Note](docs/CRI/cri-o.md). Only on fedora, ubuntu and centos based OS)
- Network Plugin
