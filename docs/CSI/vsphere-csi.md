...
| vsphere_csi_attacher_image_tag                  | TRUE     | string  |                 | "v4.10.0"               | CSI attacher image tag to use                                                                                               |
...
| vsphere_csi_liveness_probe_image_tag            | TRUE     | string  |                 | "v2.17.0"               | CSI liveness probe image tag to use                                                                                         |
| vsphere_csi_provisioner_image_tag               | TRUE     | string  |                 | "v6.1.0"                | CSI provisioner image tag to use                                                                                            |
| vsphere_csi_snapshotter_image_tag               | TRUE     | string  |                 | "v8.4.0"                | CSI snapshotter image tag to use                                                                                            |
| vsphere_csi_node_driver_registrar_image_tag     | TRUE     | string  |                 | "v2.15.0"               | CSI node driver registrar image tag to use                                                                                  |
| vsphere_csi_driver_image_tag                    | TRUE     | string  |                 | "v3.6.0"                | CSI driver image tag to use                                                                                                 |
| vsphere_csi_resizer_tag                         | TRUE     | string  |                 | "v2.0.0"                | CSI resizer image tag to use                                                                                                |
