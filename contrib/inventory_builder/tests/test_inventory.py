...
class TestInventory(unittest.TestCase):
    ...
    def test_get_ip_from_opts(self):
        optstring = {'ansible_host': '10.90.3.2', 'ip': '10.90.3.2', 'access_ip': '10.90.3.2' }
        expected = "10.90.3.2"
    ...
    def test_build_hostnames_add_one(self):
        ...
        expected = OrderedDict([('node1',
                               {'ansible_host': '10.90.0.2', 'ip': '10.90.0.2', 'access_ip': '10.90.0.2' })])
    ...
    def test_build_hostnames_add_two(self):
        ...
        expected = OrderedDict([
            ('node1', {'ansible_host': '10.90.0.2', 'ip': '10.90.0.2', 'access_ip': '10.90.0.2' }),
            ('node2', {'ansible_host': '10.90.0.3', 'ip': '10.90.0.3', 'access_ip': '10.90.0.3' })])
    ...
    def test_purge_invalid_hosts(self):
        ...
        self.assertTrue(bad_host not in self.inv.yaml_config['all']['hosts'].keys())
    ...
    def test_add_host_to_group(self):
        ...
        self.assertEqual(self.inv.yaml_config['all']['children'][group]['hosts'].get(host), None)
    ...
    def test_set_kube_master(self):
        ...
        self.assertTrue(host in self.inv.yaml_config['all']['children'][group]['hosts'])
    ...
    def test_set_k8s_cluster(self):
        ...
        for host in expected_hosts:
            self.assertTrue(host in self.inv.yaml_config['all']['children'][group]['children'])
    ...
    def test_scale_scenario_one(self):
        ...
        for h in range(3):
            self.assertFalse(list(hosts.keys())[h] in self.inv.yaml_config['all']['children']['kube-node']['hosts'])
