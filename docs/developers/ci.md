...
debian13 |  :white_check_mark: | :white_check_mark: | :x: | :x: | :x: | :x: |
fedora39 |  :white_check_mark: | :x: | :x: | :x: | :x: | :white_check_mark: |
fedora40 |  :x: | :x: | :x: | :x: | :x: | :x: |
fedora41 |  :white_check_mark: | :x: | :x: | :x: | :x: | :white_check_mark: |
...
fedora39 |  :white_check_mark: | :x: | :x: | :x: | :x: | :x: |
fedora40 |  :white_check_mark: | :x: | :x: | :x: | :x: | :x: |
fedora41 |  :white_check_mark: | :x: | :x: | :x: | :x: | :x: |
...
debian13 |  :x: | :x: | :x: | :x: | :x: | :x: |
fedora39 |  :x: | :x: | :x: | :x: | :x: | :x: |
fedora40 |  :white_check_mark: | :x: | :x: | :x: | :x: | :x: |
fedora41 |  :x: | :x: | :x: | :x: | :x: | :x: |
fedora42 |  :x: | :x: | :x: | :x: | :x: | :x: |
flatcar4081 |  :x: | :x: | :x: | :x: | :x: | :x: |
openeuler24 |  :x: | :x: | :x: | :x: | :x: | :x: |
rockylinux10 |  :x: | :x: | :x: | :x: | :x: | :x: |
