...
SUPPORTED_OS = {
  ...
  "flatcar-stable"      => {box: "flatcat-stable",             user: "core", box_url: FLATCAR_URL_TEMPLATE % ["stable"]},
  "flatcar-alpha"       => {box: "flatcat-alpha",              user: "core", box_url: FLATCAR_URL_TEMPLATE % ["alpha"]},
  "flatcar-beta"        => {box: "flatcat-beta",               user: "core", box_url: FLATCAR_URL_TEMPLATE % ["beta"]},
  "flatcar-edge"        => {box: "flatcat-edge",               user: "core", box_url: FLATCAR_URL_TEMPLATE % ["edge"]},
