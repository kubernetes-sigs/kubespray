...
* *ansible_facts.default_ipv4.address*: IP address Ansible automatically chooses.
...
* *ansible_facts.default_ipv4.address* - Not Kubespray-specific, but it is used if ip
