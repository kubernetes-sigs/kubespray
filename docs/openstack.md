...
Given the port ids on the left, you can set the two `allowed_address`(es) in OpenStack. Note that you have to allow both `kube_service_addresses` (default `10.233.0.0/18`) and `kube_pods_subnet` (default `10.233.64.0/18`.)
    ...
    openstack port set 5662a4e0-e646-47f0-bf88-d80fbd2d99ef --allowed_address ip-address=10.233.0.0/18,ip-address=10.233.64.0/18
    openstack port set e5ae2045-a1e1-4e99-9aac-4353889449a7 --allowed_address ip-address=10.233.0.0/18,ip-address=10.233.64.0/18
