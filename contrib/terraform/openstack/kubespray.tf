...
module "ips" {
  ...
  number_of_k8s_ingress_nodes   = "${var.number_of_k8s_ingress_nodes}"
...
module "compute" {
  ...
  k8s_ingress_node_fips                        = "${module.ips.k8s_ingress_node_fips}"
...
output "k8s_ingress_node_fips" {
  value = "${module.ips.k8s_ingress_node_fips}"
}
