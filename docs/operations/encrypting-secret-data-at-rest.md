...
Secretbox uses [Poly1305](https://cr.yp.to/mac.html) as message-authentication code and [XSalsa20](https://libsodium.gitbook.io/doc/advanced/stream_ciphers/xsalsa20) as secret-key authenticated encryption and secret-key encryption.
